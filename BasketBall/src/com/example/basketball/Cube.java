...
public class Cube {
	...
	private final String vertexShaderCode = "vec4 lightDir = vec4(1, 1, 0, 0); "
	...
	private final String fragmentShaderCode = "precision mediump float;"
			...
			+ "	gl_FragColor = varyingColor * max(dot(Nn, normalize(lightDir)), 0.0); "
			+
	...
	static float vertices[] = { 1, 1, 1, -1, 1, 1, -1, -1, 1, // v0-v1-v2
																// (front)
	...
	static float colors[] = {
			...
			0.545f, 0.2705f, 0.0745f,
			0.545f,
			0.2705f,
			0.0745f,
			0.545f,
			0.2705f,
			0.0745f, // v1-v6-v7 (left)
			0.545f, 0.2705f, 0.0745f, 0.545f,
			0.2705f,
			0.0745f,
			0.545f,
			0.2705f,
			...
			0.545f, 0.2705f, 0.0745f, 0.545f, 0.2705f,
			0.0745f,
			0.545f,
			0.2705f,
			0.0745f, // v7-v4-v3 (bottom)
			0.545f, 0.2705f, 0.0745f, 0.545f, 0.2705f, 0.0745f,
			0.545f,
			0.2705f,
			0.0745f, // v3-v2-v7

			0.545f, 0.2705f, 0.0745f, 0.545f, 0.2705f, 0.0745f, 0.545f,
			0.2705f,
			0.0745f, // v4-v7-v6 (back)
			0.545f, 0.2705f, 0.0745f, 0.545f, 0.2705f, 0.0745f, 0.545f,
			0.2705f, 0.0745f }; // v6-v5-v4
	...
	float color[] = { 0.545f, 0.2705f, 0.0745f, 0.5f };
	...
	public void draw(float[] mvpMatrix, float[] normalMat) { // pass in the
																// calculated
																// transformation
																// matrix, and
																// the normal
